...
<table border="0">
  <tr>
    <!-- LEFT SIDEBAR: Gray Background Effect -->
    <td width="33%" bgcolor="#f0f0f0" valign="top" style="padding:10px;">
      <br>
      <h3>EDUCATION</h3>
      <hr>
      <p><b>Bachelor of Civil Engineering</b><br>
      2014 - 2018</p>
      <br>
      <h3>SKILLS</h3>
      <hr>
    ...
    <td width="67%" valign="top" style="padding:10px;">
     ...
     <br>
      ...
      Newington Builder Inc. | 2023 – 2024<br>
...
---
### 📐 PERSONAL PORTFOLIO
* **Technical Design:** [📂 View Files](AutoCAD_Samples/Technical_Design/)
* **Structural Detailing:** [📂 View Files](AutoCAD_Samples/Structural/)
* **Cost Estimation:** [📂 View Documents](Cost_Estimate_Files/)
